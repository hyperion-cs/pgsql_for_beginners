...
2. [Вопросы](#2-questions)<br>
    ...
    2.3. [Как публиковать SQL запросы, выводы команд вспомогательных утилит и прочую текстовую информацию?](#2.3-data-publication)<br>
...
### <a name='2.3-data-publication'>2.3.</a> Как публиковать SQL запросы, выводы команд вспомогательных утилит и прочую текстовую информацию?
