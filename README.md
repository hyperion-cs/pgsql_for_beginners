...
2. [Вопросы](#2-questions)<br>
    ...
    2.3. [Как публиковать SQL запросы, выводы команд вспомогательных утилит и прочую текстовую информацию при запросе помощи у сообщества?](#2.3-data-publication)<br>
    ...
    2.5. [У меня не получается написать SQL запрос и/или я получаю ошибки. Какую информацию мне необходимо предоставить для получения помощи?](#2.5-invalid-query)<br>
...
## <a name='1-community'>1.</a> Сообщество :family_man_woman_girl_boy:
...
## <a name='2-questions'>2.</a> Вопросы :interrobang:

### <a name='2.1-connection-refused'>2.1.</a> Не могу подсоединиться к PostgreSQL. Что делать?
...
### <a name='2.2-name-does-not-exist'>2.2.</a> Получаю ошибку что имя таблицы/колонки/etc неверное, хотя это не так. В чем дело?
...
### <a name='2.3-data-publication'>2.3.</a> Как публиковать SQL запросы, выводы команд вспомогательных утилит и прочую текстовую информацию при запросе помощи у сообщества?
...
### <a name='2.4-slow-query'>2.4.</a> У меня медленно работает SQL запрос и я хочу попросить помощи у сообщества. Какую информацию мне необходимо предоставить?
...
### <a name='2.5-invalid-query'>2.5.</a> У меня не получается написать SQL запрос и/или я получаю ошибки. Какую информацию мне необходимо предоставить для получения помощи?
...
### <a name='2.6-register-codestyle'>2.6.</a> В каком регистре писать команды/функции/etc в PostgreSQL?
...
## <a name='3-books'>3.</a> Книги :blue_book:
...
## <a name='4-links'>4.</a> Полезные ссылки :link:
